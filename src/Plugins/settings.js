...
module.exports = [
 {
  ...
  operate: async ({ m, reply, isCreator, args }) => {
    ...
    if (args.length === 0) return reply("*Please specify a file to reload! For example: Casper, index.js, core.js, settings.js*");
    ...
    try {
      ...
      switch (fileName) {
        case 'System':
        case 'System.js':
          filePath = path.resolve(__dirname, '..', '..', 'System.js');
          break;
        case 'index':
        case 'index.js':
