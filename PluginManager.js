...
class PluginManager {
  ...
  async loadPlugins() {
    try {
        console.log("[CASPER-XMD] Loading plugins...");
        ...
        console.log("[CASPER-XXMD] Plugins loaded successfully.");
    } catch (error) {
        console.error("[CASPER-XMD] Error loading plugins:", error);
    }
}
...
module.exports = PluginManagerconst fs = require('fs/promises');
const path = require('path');
